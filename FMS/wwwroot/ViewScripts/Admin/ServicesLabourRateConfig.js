$(function () {
    ...
    $("#ServicesLabourRateConfigLink").addClass("active");
    $("#ServicesLabourRateConfigLink i.far.fa-circle").removeClass("far fa-circle").addClass("far fa-dot-circle");
    ...
    function loadLabourRates() {
        ...
        $('.tblLabourRate').empty();
        $.ajax({
            url: "/Admin/GetServiceLabourRates",
            type: "GET",
    ...
    function LoadProducts() {
        ...
        $.ajax({
            url: '/Admin/GetProductServiceGoods',
            type: "GET",
            contentType: "application/json;charset=utf-8",
            dataType: "json",
            success: function (result) {
