...
namespace FMS.Db.Migrations
{
    ...
    [Migration("20240321015341_Mg-001")]
    partial class Mg001
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.BranchFinancialYear", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Company", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.DamageOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.DamageTransaction", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.FinancialYear", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.InwardSupplyOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.InwardSupplyTransaction", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Journal", b =>
                {
                    ...
                    b.ToTable("Journals", "dbo");
                });

            modelBuilder.Entity("FMS.Db.DbEntity.Labour", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LabourOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LabourTransaction", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LabourType", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LedgerBalance", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LedgerDev", b =>
                {
                    b.Property<Guid>("LedgerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LedgerGroup", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LedgerSubGroup", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LedgerSubGroupDev", b =>
                {
                    b.Property<Guid>("LedgerSubGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.OutwardSupplyOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.OutwardSupplyTransaction", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Party", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Payment", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Product", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.ProductGroup", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.ProductSubGroup", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.ProductType", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Production", b =>
                {
                    ...
                    b.ToTable("Productions", "dbo");
                });

            modelBuilder.Entity("FMS.Db.DbEntity.PurchaseOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.PurchaseReturnOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Receipt", b =>
                {
                    ...
                    b.ToTable("Receipts", "dbo");
                });

            modelBuilder.Entity("FMS.Db.DbEntity.RegisterToken", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SalesConfig", b =>
                {
                    b.Property<Guid>("SalesConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.HasKey("SalesConfigId");

                    b.ToTable("SalesConfigs", "dbo");
                });

            modelBuilder.Entity("FMS.Db.DbEntity.SalesOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SalesReturnOrder", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SubLedger", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SubLedgerBalance", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Unit", b =>
                {
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.UserBranch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.AlternateUnit", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.Unit", "Unit")
                        .WithMany("AlternateUnits")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.AppUser", b =>
                {
                    b.HasOne("FMS.Db.DbEntity.RegisterToken", "Token")
                        .WithOne("User")
                        .HasForeignKey("FMS.Db.DbEntity.AppUser", "FkTokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_AppUser_RegisterToken");
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.DamageOrder", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.Labour", "Labour")
                        .WithMany("DamageOrders")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.DamageTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.DamageOrder", "DamageOrder")
                        .WithMany("DamageTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.InwardSupplyTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.InwardSupplyOrder", "InwardSupplyOrder")
                        .WithMany("InwardSupplyTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Journal", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.LedgerGroup", "LedgerGroup")
                        .WithMany("Journals")
                        .HasForeignKey("Fk_LedgerGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FMS.Db.DbEntity.SubLedger", "SubLedger")
                        .WithMany("Journals")
                        .HasForeignKey("Fk_SubLedgerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FMS.Db.DbEntity.LedgerDev", "LedgerDev")
                        .WithMany("Journals")
                        .HasForeignKey("LedgerDevLedgerId");

                    b.HasOne("FMS.Db.DbEntity.Ledger", "Ledger")
                        .WithMany("Journals")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Labour", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.LabourType", "LabourType")
                        .WithMany("Labours")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LabourTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.LabourOrder", "LabourOrder")
                        .WithMany("LabourTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Ledger", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.LedgerSubGroup", "LedgerSubGroup")
                        .WithMany("Ledgers")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.LedgerDev", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.LedgerSubGroupDev", "LedgerSubGroup")
                        .WithMany("LedgersDev")
                        .HasForeignKey("Fk_LedgerSubGroupId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.OutwardSupplyTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.OutwardSupplyOrder", "OutwardSupplyOrder")
                        .WithMany("OutwardSupplyTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Party", b =>
                {
                    b.HasOne("FMS.Db.DbEntity.City", "City")
                        .WithMany("Parties")
                    ...
                    b.HasOne("FMS.Db.DbEntity.Ledger", null)
                        .WithMany("Parties")
                        .HasForeignKey("LedgerId");
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Product", b =>
                {
                    b.HasOne("FMS.Db.DbEntity.ProductGroup", "ProductGroup")
                        .WithMany("Products")
                        .HasForeignKey("Fk_ProductGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FMS.Db.DbEntity.ProductSubGroup", "ProductSubGroup")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.PurchaseReturnTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.PurchaseReturnOrder", "PurchaseReturnOrder")
                        .WithMany("PurchaseReturnTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.PurchaseTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.PurchaseOrder", "PurchaseOrder")
                        .WithMany("PurchaseTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SalesReturnTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.SalesReturnOrder", "SalesReturnOrder")
                        .WithMany("SalesReturnTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SubLedgerBalance", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.LedgerBalance", "LedgerBalance")
                        .WithMany("SubLedgerBalances")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.UserBranch", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.AppUser", "User")
                        .WithMany("UserBranch")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FMS.Db.DbEntity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
